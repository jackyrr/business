...
public class Product implements Serializable{
	...
	public Product(int id,int category_id, String name, String subtitle, String main_image, String sub_images, String detail,
	...
	public Product(int category_id, String name, String subtitle, String main_image, String sub_images, String detail,
			BigDecimal price, int stock, int status) {
		super();
		this.category_id = category_id;
		this.name = name;
